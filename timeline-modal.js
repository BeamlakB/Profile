...
function initTimelineModals() {
  const modalsData = [
   ...
   },
   {
    ...
    image:"https://BeamlakB.github.io/Profile/img/IRL_image.png",
    links:{
        Report: "https://BeamlakB.github.io/Profile/page/Analysis.pdf",
    }
   }
